...
public class DodoorConf {
    ...
    public final static String DEFAULT_DOCKER_IMAGE_NAME = "anonymous/dodoor-function-bench";

    public final static String ROOT_DIR = "dodoor.root.dir";
    public final static String DEFAULT_ROOT_DIR = "/home/user/dodoor/deploy/python/function_bench";
    ...
    // NOTE: Sparrow late-binding scheduler has known issues with duplicate task execution due to
    // race conditions in the confirmation protocol. Excluded from paper experiments.
    ...
    // NOTE: Late-binding configuration for Sparrow-style scheduling (experimental, see note above)
    ...
    // Removed host-load simulation; placement strategies should model imbalance explicitly
    ...
    public final static String SCHEDULER_METRICS_END_TO_END_SELECTED_TASK_SCHEDULING_LATENCY_HISTOGRAMS =
            "scheduler.metrics.tasks.e2e.scheduling.latency.histograms";
    public final static String SCHEDULER_METRICS_END_TO_END_SELECTED_TASK_MAKESPAN_LATENCY_HISTOGRAMS =
    ...
    // NOTE: Metrics for experimental Sparrow late-binding scheduler (has known issues, see SPARROW_SCHEDULER)
    ...
    public final static String NODE_METRICS_HOL_BLOCKED_COUNT = "node.metrics.hol.blocked.count";
    public final static String NODE_METRICS_HOL_BLOCKED_DURATION_MS = "node.metrics.hol.blocked.duration.ms";
    ...
    public final static boolean DEFAULT_RESTRICT_FIFO = true; // Restrict FIFO task scheduler to only run one task at a time
    public final static String RESTRICT_FIFO = "restrict.fifo";


    public final static String START_TRACKING_TASK_MAKESPAN_ID = "start.tracking.task.makespan.id";
    public final static int DEFAULT_START_TRACKING_TASK_MAKESPAN_ID = 0;

    public final static String END_TRACKING_TASK_MAKESPAN_ID = "end.tracking.task.makespan.id";
    public final static int DEFAULT_END_TRACKING_TASK_MAKESPAN_ID = 7000;

    public final static boolean DEFAULT_LOG_PER_TASK_METRICS = false; // Whether to log per-task metrics like scheduling latency and makespan
    public final static String LOG_PER_TASK_METRICS_KEY = "log.per.task.metrics";
}
