...
import org.anon.scheduler.thrift.SchedulerService;
...
import org.anon.scheduler.utils.ThriftClientPool;
 ...
 *
 * NOTE: This late-binding implementation (inspired by Sparrow-style scheduling) has known issues
 * with duplicate task execution due to race conditions in the confirmation protocol. Tasks may be
 * executed on multiple nodes simultaneously. This scheduler is experimental and excluded from
 * paper experiments. The implementation is kept for reference and future debugging.
 */
