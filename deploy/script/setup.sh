...
parallel-ssh -t 0 -h deploy/resources/host_addresses/cloud_lab/test_host  "sudo apt update && sudo apt install -y python3-pip thrift-compiler stress openjdk-17-jdk openjdk-17-jre vim maven"
