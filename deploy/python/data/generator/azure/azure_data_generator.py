        ...
        for machine_id in self.machine_ids:
            ...
            for vm in vm_requests:
                ...
                if noise_intensity > 0.0:
                    noise = int(numpy.random.normal(0, noise_intensity * duration))
                    # assume the noise is in normal distribution with mean 0 and std is noise_intensity * duration
                    # and the duration should be at least 1 second and less than max_duration
                    duration = max(1000, duration + noise)
                ...
                if cores > max_cores or memory > max_memory or disk > max_disk > 0:
                    continue
