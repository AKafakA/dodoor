        ...
        for mode in modes:
            ...
            for n in range(iterations):
                ...
                try:
                    ...
                    container_id = subprocess.check_output(docker_command, stderr=subprocess.PIPE).decode(
                        'utf-8').strip()
            ...
            "instanceInfo": {
                instance_id: {
                    "resourceVector": {
                        ...
                        "disks": [1] * len(modes)  # Assuming 1 disk for each mode
                    },
                    "estimatedDuration": average_durations  # In Milliseconds
                }
            }
        }
...
if __name__ == "__main__":
    ...
    profile_tasks(
        config_path=f"{args.config_path}/merged_profiler_config.json",
