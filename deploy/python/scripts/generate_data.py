...
output_path = "deploy/resources/data/azure_data_cloudlab_10m"

azure_data_generator = AzureDataGenerator(data_path, output_path, machine_ids=range(1, 40), max_cores=48,
                                          max_memory=384 * 1024)
data = azure_data_generator.generate(10000000, 0, 1000 * 60 * 10, [0, 1/12],
                                     time_shift=1.0,
