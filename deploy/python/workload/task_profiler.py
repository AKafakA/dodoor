...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Profile Python scripts defined in a JSON config file and generate a new config with measured performance data.",
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="A unique identifier for the machine instance where this script is running (e.g., 'm5.large', 'local-dev')."
    )
    parser.add_argument(
        '-n', '--iterations',
        type=int,
